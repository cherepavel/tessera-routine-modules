...
public class ProcessingStatusWorkflowRoutineFactory implements WorkflowRoutineFactoryInterface {
    @Override
    public WorkflowRoutineInterface create(MCg3WorkflowRoutineApiInterface mCg3WorkflowRoutineApi, HealthFlagProxy healthFlagProxy) throws WorkflowRoutineOperationIncompleteException {
        try {
            return new ProcessingStatusWorkflowRoutine(mCg3WorkflowRoutineApi, healthFlagProxy);
        } catch (Exception e) {
